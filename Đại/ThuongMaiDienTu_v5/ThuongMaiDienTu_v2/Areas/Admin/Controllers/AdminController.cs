...
namespace ThuongMaiDienTu_v2.Areas.Admin.Controllers
{
    public class AdminController : Controller
    {
        ...
        // Sửa sản phẩm
        [HttpPost]
        public ActionResult ProductDetail(int id, SanPham sp, string imageUploader, string imageUploader2, string imageUploader3, string imageUploader4, string imageUploader5, int typeID, string name, string desc, int price, int priceSales)
        {
